import './HistoryOfTheBrand.scss';

const HistoryOfTheBrand = () => {
  return (
    <main className='history' id='history-of-the-brand'>
      <h1 className='history__heading'>
        History of our <span className='history__brand'>Brand</span>
      </h1>
      <div className='history__text'>
        <p className='history__about'>
        ...
        <div className='history__opacity-layer-text'></div>
      </div>
    </main>
  );
};

export default HistoryOfTheBrand;
